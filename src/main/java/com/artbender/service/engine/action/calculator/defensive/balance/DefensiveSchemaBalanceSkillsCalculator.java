package com.artbender.service.engine.action.calculator.defensive.balance;
...
@Service
@Order(1)
public class DefensiveSchemaBalanceSkillsCalculator implements DefensiveCalculator {
    ...
    @Autowired
    public DefensiveSchemaBalanceSkillsCalculator(RandomService randomService) {
