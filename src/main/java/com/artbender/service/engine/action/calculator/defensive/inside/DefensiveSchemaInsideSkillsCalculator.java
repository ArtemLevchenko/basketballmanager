package com.artbender.service.engine.action.calculator.defensive.inside;
...
@Service
@Order(0)
public class DefensiveSchemaInsideSkillsCalculator implements DefensiveCalculator {
    ...
    @Autowired
    public DefensiveSchemaInsideSkillsCalculator(RandomService randomService) {
