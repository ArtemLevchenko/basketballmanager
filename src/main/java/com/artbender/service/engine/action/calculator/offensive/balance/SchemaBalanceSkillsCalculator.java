...
@Service
@Order(5)
public class SchemaBalanceSkillsCalculator implements OffensiveCalculator {
    ...
    @Autowired
    public SchemaBalanceSkillsCalculator(RandomService randomService) {
