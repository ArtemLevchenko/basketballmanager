...
@Service
@Order(8)
public class SchemaThreeptSkillsCalculator implements OffensiveCalculator {
    ...
    @Autowired
    public SchemaThreeptSkillsCalculator(RandomService randomService) {
